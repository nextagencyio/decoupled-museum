        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto max-w-3xl text-lg leading-8 text-slate-300 md:text-xl">
              Explore the gallery&apos;s permanent works, archival treasures, and singular objects in the same nocturnal atmosphere as the home experience.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="rounded-3xl border border-slate-800 bg-slate-900/70 px-8 py-16 text-center">
              <h2 className="mb-2 text-2xl font-semibold text-white">No Collections Yet</h2>
